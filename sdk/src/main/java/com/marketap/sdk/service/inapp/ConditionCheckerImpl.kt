...
import com.marketap.sdk.service.inapp.comparison.TypeOperationBuilder
import com.marketap.sdk.service.ingestion.inapp.EventExtractor
...
class ConditionCheckerImpl : ConditionChecker {
    ...
    override fun checkPropertyCondition(
        ...
        val comparator = TypeOperationBuilder(
