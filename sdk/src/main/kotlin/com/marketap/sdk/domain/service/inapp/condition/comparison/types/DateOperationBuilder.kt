...
import com.marketap.sdk.domain.service.inapp.condition.comparison.types.util.getRecentDays
import com.marketap.sdk.domain.service.inapp.condition.comparison.types.util.month
import com.marketap.sdk.domain.service.inapp.condition.comparison.types.util.pairDateTargetOperator
import com.marketap.sdk.domain.service.inapp.condition.comparison.types.util.pairTargetOperator
import com.marketap.sdk.domain.service.inapp.condition.comparison.types.util.singleDateTargetOperator
import com.marketap.sdk.domain.service.inapp.condition.comparison.types.util.singleIntTargetOperator
import com.marketap.sdk.domain.service.inapp.condition.comparison.types.util.toLocalDate
import com.marketap.sdk.domain.service.inapp.condition.comparison.types.util.year
